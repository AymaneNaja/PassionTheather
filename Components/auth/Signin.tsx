                        ...
                        <div className="mt-12 flex flex-col items-center">
                            ...
                            <div className="w-full flex-1 mt-8">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <button
                                        className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5" onClick={() => signIn('github', { redirect: true, callbackUrl: '/' })}>
                                ...
                                <div className="mx-auto max-w-xs">
                                    ...
                                    <p className="mt-6 text-sm text-gray-600 text-center">{`Don't have an account? `}<Link href={'/auth/signup'} className='underline hover:text-violet-400 text-violet-500 transition-all'>sign up here.</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>

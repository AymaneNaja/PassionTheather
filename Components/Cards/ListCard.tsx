...
const ListCard = ({
    ...
    return <div className={`grid   animate-Card  overflow-hidden transition-all max-w-[1860px]   w-full lg:w-10/12 m-auto  ${pagnation ? 'mb-10' : ''}     `}>
        <div className='w-full flex justify-between items-baseline  mx-auto px-2 pb-2 '>
            <h1 className='md:text-5xl text-4xl  bg-gradient-to-r text-transparent bg-clip-text from-indigo-400 to-violet-800 font-extrabold animate-text  transition ease-in mb-2 py-2  '>{decodeURI(list_title).replace('%26', '&')}</h1>
